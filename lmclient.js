...
class LMClient extends EventEmitter {
     ...
     * Метод может быть вызван при любом состоянии подключения к серверу.
    ...
    *//**
     ...
     * типом учетной записи "опрос". Метод может быть вызван при любом состоянии подключения к серверу.
     ...
     * @param {Date|number|string} [ts] Метка времени: объект Date или число - количество мс от 01-01-1970 00:00:00
     * @returns {boolean}
     */
