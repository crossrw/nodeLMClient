...
* [LMClient](#LMClient)
    ...
    * [.setValue(name, value, [ts])](#LMClient+setValue) ⇒ <code>boolean</code>
...
### lmClient.setValue(name, value, [ts]) ⇒ <code>boolean</code>
...
| [ts] | <code>Date</code> \| <code>number</code> \| <code>string</code> | Метка времени: объект Date или количество мс от 01-01-1970 00:00:00 |
